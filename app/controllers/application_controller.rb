class ApplicationController < Sinatra::Base
  configure do
    ...
    set :views, File.expand_path('../../public/src/core/application/views', __dir__)
  end
  ...
  get '/login' do
    serve_static_file(File.join(settings.public_folder, 'src/usuarios/presentation/views/crearUsuario.view.html'))
  end
